...
app.use(express.static(path.join(__dirname, 'counter/build')));
app.get('/', function(req, res) {
  res.sendFile(path.join(__dirname, 'counter/build', 'index.html'));
});

/*function sendFile(name) {
  return function(req, res) {
    res.sendFile(__dirname + "/counter/build/" + name);
  };
}
